...
##
##
data <- readRDS(file = "./data/01_onset_data/prep_data_analysis_FILTERED_231211.RDS")
...
saveRDS(object = fig_s2a, file = './plots/Figure_S2a.RDS')
...
##
## save table
gtsave(table_model_onset_activity, "./tables/Table S1 raw.html")
...
saveRDS(object = figs3a, file = './plots/Figure_S3a.RDS')
...
saveRDS(object = figs3b, file = './plots/Figure_S3b.RDS')
