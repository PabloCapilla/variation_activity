...
##
##
data <- readRDS(file = "./data/02_end_data/prep_data_analysis_FILTERED_231211.RDS")
...
saveRDS(object = fig_s2b, file = './plots/Figure_S2b.RDS')
...
##
## save table
gtsave(table_model_end_activity, "./tables/TABLE S2 raw.html")
...
saveRDS(object = fig_s3c, file = './plots/Figure_S3c.RDS')
...
saveRDS(object = fig_s3d, file = './plots/Figure_S3d.RDS')
